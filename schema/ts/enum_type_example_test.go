...
var enumModType = ts.Module()

// To create an enum type, first declare a typedef from string containing the name
// of your enum
type Episode string

// Next, construct the GQL type using the ts.Enum function
var episodeType = ts.Enum[Episode](enumModType, `"All of the episodes that count"`)
