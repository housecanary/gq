...
func (c *genCtx) processEnumType(typ *types.Named) (*enumMeta, error) {
	f := fieldByName(typ, "Enum")
	td, err := parser.ParsePartialEnumTypeDefinition(f.tag)
	if err != nil {
